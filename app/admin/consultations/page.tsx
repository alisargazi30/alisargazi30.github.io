  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage and respond to consultation requests</p>
      </div>
            ...
            <CardHeader>
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="outline">{request.service_type.replace("-", " ")}</Badge>
                </div>
              </div>
            </CardHeader>
            <CardContent>
      ...
      {filteredRequests.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground text-lg">
            {searchTerm || statusFilter !== "all" ? "No requests match your filters" : "No consultation requests yet"}
          </p>
        </div>
      )}
    </div>
